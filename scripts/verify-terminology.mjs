...
// 5. "BTC 판매 확정" 문구는 "판매"로 간소화되었다.
assert.doesNotMatch(combined, /BTC 판매 확정/, "old BTC sale confirmation label is absent");
assert.match(combined, />\s*판매\s*</, "simplified sell button label is present");
