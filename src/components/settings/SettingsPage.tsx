...
import { getHeldBtc, setHeldBtc, normalizeHeldBtcInput, getHeldBtcMode } from "../../lib/heldBtc";
...
import WalletSyncSettings from "./WalletSyncSettings";
      ...
      <div className="ldg-content">
        ...
        <div className="ldg-card">
          ...
          <div className="ldg-setting-desc" style={{ marginBottom: 10 }}>
            {walletSyncMode
              ? "지갑 동기화 사용 중 — 온체인 잔고가 반영됩니다. 수동 입력은 비활성입니다."
          ...
          <div className="ldg-wallet-name-form">
            <input
              ...
              inputMode="decimal"
              className="ldg-input"
              value={walletSyncMode ? String(getHeldBtc() || "") : heldBtcInput}
              readOnly={walletSyncMode}
              onChange={(e) => {
                if (walletSyncMode) return;
